...
- [x] generate a thumbnail for the audio that's ideally embedded with the latest nano banana model and add a blue standard stylish border on top of it so they'll be consistent
