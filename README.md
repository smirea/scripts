...
- `git-invite-ai-to-repos` (`src/git-invite-ai-to-repos.ts`): invite the configured AI GitHub account to owner repositories created in the past year, then accept those invitations as the AI account using GitHub CLI's stored multi-account auth.
